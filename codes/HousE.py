...
from DataloaderStage1 import TestDataset
...
class HousEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, house_dim, house_num, housd_num, thred,
        ...
        self.entity_embedding = nn.Parameter(torch.zeros(nentity + 1, self.entity_dim, self.house_dim))
        nn.init.uniform_(
        ...
        if self.model_name == 'HousE' or self.model_name == 'HousE_plus':
        ...
        if self.model_name == 'HousE_r_plus' or self.model_name == 'HousE_plus':
